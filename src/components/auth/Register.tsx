                            ...
                            <div className="card-body p-md-5">
                                <div className="row justify-content-center">
                                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <p className="text-center mb-5 mx-1 mx-md-4 mt-4">do you have any account please <Link href="../login">Log in</Link></p>

                                        <form onSubmit={handleSubmit(onSubmit)} className="mx-1 mx-md-4">

                                            <div className="d-flex flex-row align-items-center mb-4">
                                                <i className="fas fa-user fa-lg me-3 fa-fw d-none d-sm-block"></i>
                                                <div className="form-outline flex-fill mb-0">
                                                    <i className="fas fa-user fa-lg me-3 fa-fw d-sm-none"></i>
                                                    <label className="form-label" htmlFor="form3Example1c">Your Name</label>
                                                    <input type="text" {...register("name", { required: true })} id="form3Example1c" className="form-control" />
                                            ...
                                            <div className="d-flex flex-row align-items-center mb-4">
                                                <i className="fas fa-key fa-lg me-3 fa-fw d-none d-sm-block"></i>
                                                <div className="form-outline flex-fill mb-0">
                                                    <i className="fas fa-key fa-lg me-3 fa-fw d-sm-none"></i>
